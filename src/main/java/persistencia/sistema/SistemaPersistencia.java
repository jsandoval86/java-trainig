...
import persistencia.repositorio.RepositorioParqueadero;
...
public class SistemaPersistencia {
	...
	public IRepositorioParqueadero repositorioParquedero() {
		return new RepositorioParqueadero(this.entityManager);
	}
